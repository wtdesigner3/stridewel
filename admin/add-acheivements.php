...
//=============|image|============//
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_acheivements`(`title`,`subtitle`,`ach_image`,`alt`,`description`,`numbers`, `name`, `sort`, `status`) VALUES ('$title','$subtitle','$bimage','$alt','$desc','$numbers','$name','$position','$status')");
    if($query==true)
    {
			...
			<form role="form"  method="POST"  enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <label for="exampleInputPassword1" class="d-none">Achievement Subtitle</label>
                  <input type="hidden" name="subtitle" class="form-control" id="exampleInputPassword1" placeholder="Enter Achievement Subtitle">
                </div>

                  <div class="form-group d-none">
					<label for="exampleInputPassword1">Achievement Alt</label>
					<input type="text" name="alt" class="form-control" id="exampleInputPassword1" placeholder="Enter Achievement Alt">
				  </div>
               ...
               <div class="form-group col-4">
                ...
                <div class="form-group col-4">
                  ...
                  <input type="text" name="numbers" class="form-control" id="" placeholder="Ex: 99" required>
                </div>
                
                 <div class="form-group col-4">
                  <label for="exampleInputPassword1">Unit</label>
                  <input type="text" name="title" class="form-control" id="exampleInputPassword1" placeholder="Enter Achievement Title">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" id="exampleInputPassword1" placeholder="Enter Achievement Name" required>
                </div>

                   <div class="form-group d-none">
                  <label for="exampleInputPassword1">Description</label>
                  <input type="text" name="desc" class="form-control" id="exampleInputPassword1" placeholder="Enter Description Here!">
                </div>
