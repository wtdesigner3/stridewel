...
if (isset($_POST['Deactivate']) && isset($_POST['bb'])) {
    $bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_quick_links set status='0' where id='$act'");
	}
}
...
if (isset($_POST['Activate']) && isset($_POST['bb'])) {
    $bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_quick_links set status='1' where id='$act'");
	}
}
...
if (isset($_POST['Delete']) && isset($_POST['bb'])) {
    $bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "delete from tbl_quick_links where id='$act'");
	}
}
...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Manage Quick Links </li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Quick Links </h4>
						</div>
						<!-- end panel-heading -->
						<form name="myform" method="post" action="">
							...
							<!--<div class="alert alert-secondary fade show">-->
								...
								<!--	<a href="add-quick-links.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Quick Links</a>-->
	...
	<script>
		function updateId(id) {
			...
			xmlhttp.open("GET", "status/quick-links.php?id=" + id, true);
			xmlhttp.send();
		}
	</script>
	<!----------------Check Box----------------------->
