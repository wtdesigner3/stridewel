...
// 		move_uploaded_file($_FILES["image1"]["tmp_name"], "../uploads/why_choose/" . $image1);
// 	} else {
// 		$image1 = $oldimage1;
// 	} 
	...
	if ($image4 != "") {
		...
		@unlink("../uploads/works/" . $oldicon3);
		move_uploaded_file($_FILES["image4"]["tmp_name"], "../uploads/works/" . $image4);
	} else {
		$image4 = $oldicon3;
	} 
	...
	if ($image5 != "") {
		...
		@unlink("../uploads/works/" . $oldicon4);
		move_uploaded_file($_FILES["image5"]["tmp_name"], "../uploads/works/" . $image5);
	} else {
		$image5 = $oldicon4;
	} 
...
// 	} 
	...
	$query = mysqli_query($conn, "UPDATE `tbl_howworks` SET `icon1`='$image2',`icon2`='$image3',`icon3`='$image4',`icon4`='$image5',`heading1`='$heading1',`heading2`='$heading2',`heading3`='$heading3',`heading4`='$heading4',`content1`='$content1',`content2`='$content2',`content3`='$content3',`content4`='$content4'"); 
	if ($query == true) {
...
<body>
	...
	<div id="content" class="content">
		...
		<ol class="breadcrumb pull-right">
			<li class="breadcrumb-item"><a href="javascript:;">How Works Management</a></li>
			<li class="breadcrumb-item active">Edit How Works</li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)" class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i class="fa fa-arrow-left"></i></a> Manage How Works</h1>
		<!-- begin row -->
		<div class="row">
			<!-- begin col-10 -->
			<div class="col-lg-12">
				...
				<div class="panel panel-inverse">
					...
					<div class="panel-heading">
						...
						<h4 class="panel-title"> Edit How Works</h4>
					</div>
					<!-- begin panel-body -->
							...
							<div class="box-body">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
    									...
    									<p class="help-block">Image dimension must be 570 × 569 px & must be jpg format</p>
    									<img src="../uploads/works/<?= $brec['icon4']; ?>" style="width:30%; height:100px" class="bg-dark">
    								</div>
								</div>
								...
								<div class="form-group col-3">
									...
									<input type="text" class="form-control" value="<?= $brec['heading1'] ?>" name="heading1" placeholder="Heading 1" >
								</div>
								    
								<div class="form-group col-3">
									<label for="banner">Enter Icon Heading 2</label>
									<input type="text" class="form-control" value="<?= $brec['heading2'] ?>" name="heading2" placeholder="Heading 2" >
								</div>
								    
								<div class="form-group col-3">
									<label for="banner">Enter Icon Heading 3</label>
									<input type="text" class="form-control" value="<?= $brec['heading3'] ?>" name="heading3" placeholder="Heading 3" >
								</div>
								    
								<div class="form-group col-3">
									<label for="banner">Enter Icon Heading 4</label>
									<input type="text" class="form-control" value="<?= $brec['heading4'] ?>" name="heading4" placeholder="Heading 4" >
								</div>
