...
if (isset($_POST['Delete']) && isset($_POST['bb'])) {
    $bb = $_POST['bb'];
    foreach ($bb as $act) {
        mysqli_query($conn, "delete from tbl_career where id='$act'");
    }
}
?>
<!DOCTYPE html>
...
<body>
                        ...
                        <form name="myform" method="post" action="">
                            ...
                            <div class="alert alert-secondary fade show">
                                ...
                                <div class="btn-group btn-group-justified">
                                    <a href="add-career.php" class="btn btn-default active"><i
                                            class="fa fa-plus"></i>Add New Career</a>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="data-table-responsive" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            $mqry = "select * from tbl_career order by id desc";
                                            $count = 1;
                                            ...
                                            while ($web = mysqli_fetch_array($fetch)) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td width="1%" class="with-img"><?= $web['job_title']; ?></td>
                                                    <td width="1%" class="with-img">
                                                        <?= substr($web['job_desc'], 0, 40); ?>...</td>
                                                    <td>
                                                        <div class="switcher">
                                                            <input type="checkbox"
    ...
    <script>
        function updateId(id) {
            ...
            xmlhttp.open("GET", "status/career.php?id=" + id, true);
            xmlhttp.send();
        }
    </script>
