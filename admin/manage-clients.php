...
if (isset($_POST['Deactivate']) && $bb != '') {
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_client set status='0' where id='$act'");
	}
}

if (isset($_POST['Activate']) && $bb != '') {
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_client set status='1' where id='$act'");
	}
}

if (isset($_POST['Delete']) && $bb != '') {
	foreach ($bb as $act) {
		mysqli_query($conn, "delete from tbl_client where id='$act'");
	}
}

$mqry = "select * from tbl_client ";
...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;"> Trusted Clients Management</a></li>
				<li class="breadcrumb-item active">Manage Trusted Clients</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Trusted Clients</h4>
						</div>
						<!-- end panel-heading -->
						<form name="myform" method="post" action="">
							...
							<div class="alert alert-secondary fade show">
								...
								<div class="btn-group btn-group-justified">
									<a href="add-clients.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Trusted Clients</a>
	...
	<script>
		function updateId(id) {
			...
			xmlhttp.open("GET", "status/clients.php?id=" + id, true);
			xmlhttp.send();
		}
	</script>
	<!----------------Check Box----------------------->
